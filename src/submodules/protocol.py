...
.. data:: bits [2:4]: speed selector, obtained by the SPEED dictionary
...
.. data:: bits [5:7]: function selector, obtained by the FUNCTION dictionary
...
we need to add the bit inverted ::
